...
Bitmap indices are best used when the set of possible key values in the index is small with a large number of rows, e.g. gender attribute \cite{oneil1995multi}.
...
\hline
\textbf{Data Warehouses} & E.g. Universal B+tree, Bitmap index, Projection Index & 
-Essential to improve performance \linebreak \linebreak 
-Not applicable to adhoc queries & 
